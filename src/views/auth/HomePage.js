...
import DisclaimerPage from '../auth/DisclaimerPage'
...
class HomePage extends React.Component {
	...
	handleDisclaimerClose = () => {
		this.setState({isDisclaimerClose: true});
	};
	...
	render() {
		...
		return (
			<>
				{this.props.quizzes && this.state.isDisclaimerClose === true ? (
					...
					<DisclaimerPage userData={currentUser} handleClose={() => {this.handleDisclaimerClose()}}/>
				)}
			</>
		);
	}
